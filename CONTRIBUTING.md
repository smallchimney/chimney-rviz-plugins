...
The [issue tracker](https://github.com/smallchimney/chimney-rviz-plugins/issues) is
...
* Please **do not** use the issue tracker for personal support requests
  (email to author <smallchimney@foxmail.com> for that).
...
may want to consult the [step-by-step guide on preparing and submitting a pull request](https://github.com/smallchimney/chimney-rviz-plugins/wiki/A-step-by-step-guide-on-preparing-and-submitting-a-pull-request).
...
prepared for merging into chimney-rviz-plugins:

1. Source code adheres are not strict yet, you can use any style of code you like.
...
This project is under 100% [Apache Licensed V2](LICENCE), and by submitting a
patch, you agree to allow Open Perception, Inc. to license your work under the
terms of the ALV2. The corpus of the license should be inserted as a C++
comment on top of each `.h` and `.cpp` file:
